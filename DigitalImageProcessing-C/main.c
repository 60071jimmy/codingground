...
{																		//	進入主程式 
	...
	BmpWrite(ArrayToRAWImage(BMPHaarWavelet2(BmpToGraylevel(RGBImage1.IMAGE_DATA,RGBImage1.XSIZE, RGBImage1.YSIZE),RGBImage1.XSIZE, RGBImage1.YSIZE, (HighHigh|HighLow|LowHigh)), RGBImage1.XSIZE, RGBImage1.YSIZE), BMPImage1.XSIZE, BMPImage1.YSIZE, "RGBGrayHaarHighFreq");
	//	呼叫BmpToGraylevel將影像轉為灰階後，再呼叫BMPHaarWavelet2副程式計算小波轉換，呼叫ArrayToRAWImage副程式將AnalysisData轉換回BMP影像資料格式後以BmpWrite副程式寫入BMP檔
	
	BmpWrite(ArrayToRAWImage(BMP24RGBSobelEdge(RGBImage1.IMAGE_DATA,RGBImage1.XSIZE, RGBImage1.YSIZE), RGBImage1.XSIZE, RGBImage1.YSIZE), BMPImage1.XSIZE, BMPImage1.YSIZE, "BMPSobelEdge");
	//	呼叫BMP24RGBGradient副程式計算影像Sobel邊緣後，呼叫ArrayToRAWImage副程式將AnalysisData轉換回BMP影像資料格式後以BmpWrite副程式寫入BMP檔
	
	BmpWrite(ArrayToRAWImage(BMP24RGBSobelEdge(BmpToGraylevel(RGBImage1.IMAGE_DATA, RGBImage1.XSIZE, RGBImage1.YSIZE), RGBImage1.XSIZE, RGBImage1.YSIZE), RGBImage1.XSIZE, RGBImage1.YSIZE), BMPImage1.XSIZE, BMPImage1.YSIZE, "BMPGraySobelEdge");
	//	呼叫BmpToGraylevel將影像轉為灰階後，再呼叫BMP24RGBGradient副程式計算影像Sobel邊緣，再呼叫ArrayToRAWImage副程式將AnalysisData轉換回BMP影像資料格式後以BmpWrite副程式寫入BMP檔
	...
	ViewBMPImage("BMPGraySobelEdge");									//	呼叫ViewBMPImage檢視圖檔
