	...
	*/
	...
	{																	//	進入else敘述 
		...
		{																//	進入else敘述 
			...
			BmpWrite(ArrayToRAWImage(RGBHistogramEqualization(BmpToGraylevel(AnalysisData,xsize, ysize),xsize, ysize), xsize, ysize), xsize, ysize, "RGBGraylevelHisEqual");
			...
			BmpWrite(ArrayToRAWImage(HSVToBMP24RGB(AnalysisDataHSV,xsize, ysize),xsize, ysize),xsize, ysize,"HSVToRGB");
			...
			//HSVDataToTxt("HSVText",AnalysisDataHSV, xsize, ysize);		//	呼叫HSVDataToTxt副程式，將HSV型態之影像資料寫入txt檔
			
			BmpWrite(ArrayToRAWImage(ValueToBMP24RGB(AnalysisDataHSV,xsize, ysize),xsize, ysize),xsize, ysize,"Value");
			...
			BmpWrite(ArrayToRAWImage(SaturationToBMP24RGB(AnalysisDataHSV,xsize, ysize),xsize, ysize),xsize, ysize,"Saturation");
			...
			BmpWrite(ArrayToRAWImage(HueToBMP24RGB(AnalysisDataHSV,xsize, ysize),xsize, ysize),xsize, ysize,"Hue");
			...
			BmpWrite(ArrayToRAWImage(HSVToBMP24RGB(HSVHistogramEqualization(AnalysisDataHSV,xsize, ysize),xsize, ysize),xsize, ysize),xsize, ysize,"HSVHisEqual");
			...
			BmpWrite(ArrayToRAWImage(HSVToBMP24RGB(HSVSkin(AnalysisDataHSV,xsize, ysize),xsize, ysize),xsize, ysize),xsize, ysize,"HSVSkin");
			...
			//ViewBMPImage("HSVSkin");									//	呼叫ViewBMPImage檢視圖檔
			//system("pause");											//	暫停程式 
			return 0;													//	傳回0 
		}																//	結束else敘述 
	}																	//	結束else敘述 
