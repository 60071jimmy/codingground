	...
	*/
	...
	{																	//	進入else敘述 
		...
		{																//	進入else敘述 
			...
			//ViewBMPImage("HSVToRGB");									//	呼叫ViewBMPImage檢視圖檔
			//system("pause");											//	暫停程式 
			return 0;													//	傳回0 
		}																//	結束else敘述 
	}																	//	結束else敘述 
...
{																		//	進入HSVToBMP24RGB副程式
	...
	{																	//	進入for迴圈
		...
		{																//	進入for迴圈
			...
			if(hi == 0)													//	若hi=0
			{															//	進入if敘述
				OutputData[LoopNumber1 * xsize + LoopNumber2].R = V;	//	填入R資料
				OutputData[LoopNumber1 * xsize + LoopNumber2].G = t;	//	填入G資料
				OutputData[LoopNumber1 * xsize + LoopNumber2].B = p;	//	填入B資料
			}															//	結束if敘述
			else if(hi == 1)											//	若hi=1
			{															//	進入else if敘述
				OutputData[LoopNumber1 * xsize + LoopNumber2].R = q;	//	填入R資料
				OutputData[LoopNumber1 * xsize + LoopNumber2].G = V;	//	填入G資料
				OutputData[LoopNumber1 * xsize + LoopNumber2].B = p;	//	填入B資料
			}															//	結束else if敘述
			else if(hi == 2)											//	若hi=2
			{															//	進入else if敘述
				OutputData[LoopNumber1 * xsize + LoopNumber2].R = p;	//	填入R資料
				OutputData[LoopNumber1 * xsize + LoopNumber2].G = V;	//	填入G資料
			...
			{															//	進入else if敘述
				...
				OutputData[LoopNumber1 * xsize + LoopNumber2].B = V;	//	填入B資料
			}															//	結束else if敘述
			else if(hi == 4)											//	若hi=4
			{															//	進入else if敘述
				OutputData[LoopNumber1 * xsize + LoopNumber2].R = t;	//	填入R資料
				OutputData[LoopNumber1 * xsize + LoopNumber2].G = p;	//	填入G資料
				OutputData[LoopNumber1 * xsize + LoopNumber2].B = V;	//	填入B資料
			}															//	結束else if敘述
			else if(hi == 5)											//	若hi=5
			{															//	進入else if敘述
